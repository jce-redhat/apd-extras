...
6. At this point the demo can be more free-form.  You might:
    1. Display the [variable file](https://github.com/jce-redhat/apd-extras/blob/main/demos/snow/vars/bulk-cmdb-records.yml) used to add the hosts.
